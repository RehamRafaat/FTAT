        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">All Painters</h1>
                    <br>
                    <form action="search_painter.php" method="post">
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                ...
                if(isset($_POST['submit']))
                {
                    include "DBH.Inc.php";
                    $search = $_POST['search'];
                    $query = "SELECT * from designer WHERE job_title = 3 AND designer_name LIKE '%$search%' ";
